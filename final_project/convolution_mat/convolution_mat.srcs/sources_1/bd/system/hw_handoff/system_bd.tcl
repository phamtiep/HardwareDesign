...
proc create_root_design { parentCell } {
  ...
  # Create instance: matrix_conv_0, and set properties
  set matrix_conv_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:matrix_conv:0.0 matrix_conv_0 ]
  ...
  connect_bd_net -net blk_mem_gen_0_rsta_busy [get_bd_pins blk_mem_gen_0/rsta_busy] [get_bd_pins matrix_conv_0/a_q0]
  connect_bd_net -net blk_mem_gen_1_rsta_busy [get_bd_pins blk_mem_gen_1/rsta_busy] [get_bd_pins matrix_conv_0/b_q0]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins matrix_conv_0/ap_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net processing_system7_0_TTC0_WAVE0_OUT [get_bd_pins matrix_conv_0/ap_start] [get_bd_pins processing_system7_0/TTC0_WAVE0_OUT]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins matrix_conv_0/ap_rst] [get_bd_pins util_vector_logic_0/Res]
