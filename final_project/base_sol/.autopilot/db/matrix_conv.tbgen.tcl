...
set C_modelArgList {
	{ a int 8 regular {array 100 { 1 3 } 1 1 }  }
	{ b int 8 regular {array 9 { 1 3 } 1 1 }  }
	{ res int 16 regular {array 64 { 0 3 } 0 1 }  }
}
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "1682", "Max" : "1682"}
]}
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 7 }  { a_ce0 mem_ce 1 1 }  { a_q0 mem_dout 0 8 } } }
	b { ap_memory {  { b_address0 mem_address 1 4 }  { b_ce0 mem_ce 1 1 }  { b_q0 mem_dout 0 8 } } }
	res { ap_memory {  { res_address0 mem_address 1 6 }  { res_ce0 mem_ce 1 1 }  { res_we0 mem_we 1 1 }  { res_d0 mem_din 1 16 } } }
}
