...
if {[file isfile matrix_conv.autotvin.dat]} {
	file delete -force matrix_conv.autotvin.dat
}

if {[file isfile matrix_conv.autotvout.dat]} {
	file delete -force matrix_conv.autotvout.dat
}
