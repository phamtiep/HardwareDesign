...
# ==============================================================
set ::env(PATH) "$::env(PATH);E:/phan_mem_hoc/Vivado/2018.3/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);E:/phan_mem_hoc/Vivado/2018.3/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);E:/phan_mem_hoc/Vivado/2018.3/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);E:/phan_mem_hoc/Vivado/2018.3/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);E:/phan_mem_hoc/Vivado/2018.3/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matrix_conv.autotvin.dat"
	set constFileTvOut       "matrix_conv.autotvout.dat"
	set constFileHdlTvIn     "matrix_conv.autohdltvin.dat"
	set constFileHdlTvOut    "matrix_conv.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
