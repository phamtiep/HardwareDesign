...
AUTOPILOT_ROOT := E:/phan_mem_hoc/Vivado/2018.3
...
ifndef AP_GCC_PATH
  AP_GCC_PATH := E:/phan_mem_hoc/Vivado/2018.3/msys64/mingw64/bin
endif
...
$(ObjDir)/matrix_conv_test.cpp_pre.cpp.tb.o : matrix_conv_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling matrix_conv_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/matrix_conv.cpp_pre.cpp.tb.o : matrix_conv.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling matrix_conv.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
